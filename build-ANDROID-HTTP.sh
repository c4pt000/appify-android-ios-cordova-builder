...
echo ""
echo ""
echo "this is a HTTP build script if your site in www/index.html is HTTPS hit crtl-C to cancel script will pause for 5 seconds"
sleep 5s
cp -rf ./platforms/android/app/src/main/AndroidManifest.http.xml ./platforms/android/app/src/main/AndroidManifest.xml  
